...
🔹 **3. Construção de tópicos**

Os tópicos são blocos de conversa que definem como o agente responde a perguntas ou comandos. Cada tópico pode conter gatilhos (palavras-chave ou frases) que ativam o fluxo. Dentro do fluxo, o criador define mensagens, perguntas e ações que o agente executará.
